       ...
       const tbody = document.getElementById("cuerpo-clasificacion");
        ...
        tbody.innerHTML = tablaArray.map((eq, i) => {
            ...
            if (contenedor) {
                ...
                const opciones =
                    ranking.ataque
                        .filter(e => e.equipo !== "Las Pistas FC")
                        .map(e =>
                ...
                contenedor.innerHTML = `
                    ...
                    <div class="ranking-laspistas">

                        <div class="ranking-dato">
